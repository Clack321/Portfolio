    ...
    return (
      ...
      <div className="contact-me-outer-box">
        <form className="contact-me-form" onSubmit={e => this.sendEmail(e)}>
          ...
          <br/>
          <input className="contact-me-name"  name="contact-me-name" type="text" placeholder="Ex: David" onChange={(e) => this.updateName(e.target.value)} value={this.props.name}></input>
          </label>
          <label htmlFor="contact-me-email">Enter Your email<br />
          <input className="contact-me-email" name="contact-me-email" type="email" placeholder="Ex: David@gmail.com" onChange={(e) => this.updateEmail(e.target.value)} value={this.props.email}></input>
          </label>
          <label htmlFor="contact-me-message">Type your message
          <br/>
          <textarea className="contact-me-message" name="contact-me-message" placeholder="Your Message Goes Here!" onChange={(e) => this.updateMessage(e.target.value)} value={this.props.message}></textarea>
          </label>
