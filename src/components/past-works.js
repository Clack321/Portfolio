      ...
      <div id="App">
        ...
        <main className={`outer-box ${showExtendedDisplay(this.props.showSlideShow)}`}>
          <div id={this.props.showSlideShow ? "extended-inner" : "inner-box"}>
            <h1 className="past-works-title">
              {this.props.pastWorks[this.props.projectIndex].title}
            </h1>
            <p className="past-works-description">
              {this.props.pastWorks[this.props.projectIndex].description}
            </p>
            ...
            {this.props.showSlideShow ? (
              <img
                alt="A screenshot of a past project"
                src={`images/${this.props.pastWorks[this.props.projectIndex].appPhotoLinks[this.props.pictureIndex]}`}
                className="past-works-image"
              />
              ) : null}
            <div className="output-box-container">
              <button className="move-projects-left-button" onClick={() => this.moveMenuLeft()}>
                Prev
              </button>
